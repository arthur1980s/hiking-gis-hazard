...
const I18N = {
  ...
  zh: {
    ...
    'layer.fires': '山火',
    'layer.fires.title': 'NASA FIRMS 卫星山火热点',
    'layer.quakes': '地震',
    ...
    'err.firms.nokey': 'NASA FIRMS 数据源未配置, 山火点数据不可用',
    'err.firms.unreachable': 'NASA FIRMS 数据源不可达(超时/网络受限), 山火风险未知, 请出发前另行核查',
  ...
  en: {
    ...
    'layer.fires': 'Fires',
    'layer.fires.title': 'NASA FIRMS satellite hotspots',
    'layer.quakes': 'Quakes',
    ...
    'err.firms.nokey': 'NASA FIRMS source not configured; fire data unavailable',
    'err.firms.unreachable': 'NASA FIRMS unreachable (timeout/network); fire risk unknown, verify before departure',
